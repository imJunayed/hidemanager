            ...
            <div  class="col-lg-8 my-0 mx-auto p-0">
                ...
                <div class="col-12 p-0 m-0 mt-5 mb-3 text-center">
                    <div class="group_autoload d-flex justify-content-center btn-group btn-group-lg mt-3" role="group" >
                        <div class="font-weight-bold" style="font-size: 1.2rem"><span class="hmwp_logo hmwp_logo_30 align-top mr-2"></span><?php echo HMWP_Classes_Tools::getOption('hmwp_plugin_name') . ' - ' . esc_html__("Advanced Pack", 'hide-my-wp'); ?></div>
                    </div>
                ...
                <div class="col-12 row m-0 p-0 my-5 text-center">
                    <form method="post" class="col-12 p-0 m-0">
                        ...
                        <button type="submit" class="btn btn-success" >
                            <?php echo esc_html__("Install/Activate", 'hide-my-wp') . ' ' . HMWP_Classes_Tools::getOption('hmwp_plugin_name') . ' - ' . esc_html__("Advanced Pack", 'hide-my-wp') ?>
                        </button>
                    </form>
